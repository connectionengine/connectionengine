...
import { defineRelation, getRelationTargets } from './relation'
import { setUID, createNamedEntity, getEntityByUID } from './identity'
import { createEntity } from './entity'
import { destroyWorld } from './world'
...
describe('Two-peer authored replication', () => {
  ...
  it('removeComponent replicates as a remove triple', async () => {
    ...
    // Now remove on A
    const { removeComponent } = await import('./component')
  ...
  it('relations replicate by walking path on receive', async () => {
    ...
    const { addRelation } = await import('./relation')
