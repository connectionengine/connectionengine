...
import { getComponent, getComponentById, hasComponent, setComponent } from './component'
import { ROOT_PARENT, getEntityByUID, getEntityPath, setUID } from './identity'
import { addRelation, getRelationByName, getRelationTargets } from './relation'
